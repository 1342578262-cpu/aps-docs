...
黑神话黑王牛论文写作和文献调研共享同一份"文献数据源"：调研产出结构化文献清单，写作时直接转成 BibTeX 和笔记。整合后一次调研的结果可以反复用于多篇论文，避免重复检索和格式不一致。
...
<img src="/assets/2vbb_tikz_main.svg" alt="2vββ TikZ 图" class="full-width-img">
