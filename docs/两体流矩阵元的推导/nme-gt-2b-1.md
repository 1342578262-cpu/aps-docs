...
& \underset{P357(2)}{\overset{\cite{doi:10.1142/0270}}{=}} \delta_{\tau_a \tau_{a^\prime}}\delta_{\tau_b, -\frac{1}{2}}\delta_{\tau_{b^\prime}, \frac{1}{2}} \sum_{L_{ab}S_{ab}L_{a^\prime b^\prime}S_{a^\prime b^\prime}} \hat{j}_a\hat{j}_b\hat{j}_{a^\prime}\hat{j}_{b^\prime}\hat{L}_{ab}\hat{S}_{ab}\hat{L}_{a^\prime b^\prime}\hat{S}_{a^\prime b^\prime}  \left\{\begin{array}{lll}l_{a} & l_{b} & L_{ab} \\ \frac{1}{2} & \frac{1}{2} & S_{ab} \\j_{a} & j_{b} & J_{ab} \end{array}\right\} \left\{\begin{array}{lll}l_{a^\prime} & l_{b^\prime} & L_{a^\prime b^\prime} \\ \frac{1}{2} & \frac{1}{2} & S_{a^\prime b^\prime} \\j_{a^\prime} & j_{b^\prime} & J_{a^\prime b^\prime} \end{array}\right\} \notag \\
& \cdot \sum_{nlNL,n^\prime l^\prime N^\prime L^\prime} \big\langle\!\big\langle N L, n l \big| n_{a} l_{a}, n_{b} l_{b} \big\rangle\!\big\rangle^{L_{ab}} \big\langle\!\big\langle N^\prime L^\prime, n^\prime l^\prime \big| n_{a^\prime} l_{a^\prime}, n_{b^\prime} l_{b^\prime} \big\rangle\!\big\rangle^{L_{a^\prime b^\prime}} \notag \\
& \cdot \delta_{2N+L+2n+l,2n_a+l_a+2n_b+l_b}\delta_{2N^\prime+L^\prime+2n^\prime+l^\prime,2n_{a^\prime}+l_{a^\prime}+2n_{b^\prime}+l_{b^\prime}} \notag \\
